...
Code for the analysis of AI research and development
...
------------
    ...
    │
    ├── setup.py           <- makes project pip installable (pip install -e .) so ai_analysis can be imported
    │
    ├── ai_analysis                <- Source code for use in this project.
    │   ├── __init__.py    <- Makes ai_analysis a Python module
    │   │
